...
import {serviziirrigazione} from '../data/services';
import Footer from './Footer';

function ImpiantiIrrigazione() {
        ...
        >
          ...
          <Fade in={true} timeout={1000} style={{ transitionDelay: '300ms' }}>
            <Box sx={{ mb: 6, textAlign: 'center' }}>
              ...
              >
                Scopri le nostre soluzioni personalizzate per impianti di irrigazione efficienti e sostenibili, pensate per valorizzare ogni spazio verde con precisione e rispetto per l’ambiente.
              </Typography>
            </Box>
          </Fade>
          ...
          >
            ...
            >
              {serviziirrigazione.map((servizio, index) => (
                <Grid 
                  item 
                  key={servizio.id} 
                  xs={12} 
...
export default ImpiantiIrrigazione;
